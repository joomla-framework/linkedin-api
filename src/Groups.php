...
class Groups extends Object
{
	 ...
	 *                                     Values are: non-member, awaiting-confirmation, awaiting-parent-group-confirmation, member,
	 ...
	 * @param   string   $digestFrequency  E-mail digest frequency.
	 * @param   boolean  $announcements    E-mail announcements from managers.
	 * @param   boolean  $allowMessages    Allow messages from members.
	 * @param   boolean  $newPost          E-mail for every new post.
	 *
	 * @return  array  The decoded JSON response
	 *
	 * @since   1.0
	 */
	public function changeSettings($groupId, $showLogo = null, $digestFrequency = null, $announcements = null, $allowMessages = null, $newPost = null)
	{
		$token = $this->oauth->getToken();
	 ...
	 * @since   1.0
	 */
	public function joinGroup($groupId, $showLogo = null, $digestFrequency = null, $announcements = null, $allowMessages = null, $newPost = null)
	{
		$token = $this->oauth->getToken();
	 ...
	 * @since   1.0
	 */
	private function processLikeUnlike($postId, $like)
	{
		$token = $this->oauth->getToken();
	...
	{
		return $this->processLikeUnlike($postId, true);
	}
	...
	{
		return $this->processLikeUnlike($postId, false);
	}
	 ...
	 * @since   1.0
	 */
	private function processFollowUnfollow($postId, $follow)
	{
		$token = $this->oauth->getToken();
	...
	{
		return $this->processFollowUnfollow($postId, true);
	}
	...
	{
		return $this->processFollowUnfollow($postId, false);
	}
