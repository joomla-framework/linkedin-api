...
class People extends Object
{
	 ...
	 * @param   boolean  $currentCompany  A value of true matches members who currently work at the company specified in the company-name parameter.
	 ...
	 *                                    current-company, past-company and school, in exactly this order, null must be specified for an
	 *                                    element if no value.
	 * @param   integer  $start           Starting location within the result set for paginated returns.
	 * @param   integer  $count           The number of results returned.
	 * @param   string   $sort            Controls the search result order. There are four options: connections, recommenders, distance and relevance.
	 *
	 * @return  array  The decoded JSON response
	 *
	 * @since   1.0
